...
def print_per_batch(example_ind, is_print, coref_logits, gold_clusters, gold_mentions, input_ids,
count_clusters, count_mentions, count_pronouns_mentions, count_clusters_with_pronoun_mention, count_missed_mentions,
count_missed_pronouns, count_excess_pronous, count_excess_mentions, tokenizer, num_queries):
    predicted_clusters = calc_predicted_clusters(coref_logits.cpu().detach().unsqueeze(0),
                                                        [gold_mentions], num_queries)
...
def print_predictions(all_coref_logits, all_gold_clusters, all_gold_mentions, all_input_ids, args, tokenizer):
    ...
    for i, input_ids in enumerate(all_input_ids):
        ...
        count_clusters, count_mentions, count_pronouns_mentions, count_clusters_with_pronoun_mention, \
            ...
            all_coref_logits[i], gold_clusters, gold_mentions, input_ids,
            count_clusters, count_mentions, count_pronouns_mentions, count_clusters_with_pronoun_mention, count_missed_mentions,
            count_missed_pronouns, count_excess_pronous, count_excess_mentions, tokenizer, args.num_queries)
...
def error_analysis(all_coref_logits, all_gold_clusters, all_gold_mentions, all_input_ids, num_queries):
    ...
    for i in range(len(all_input_ids)):
        gold_clusters = all_gold_clusters[i]
        gold_mentions = all_gold_mentions[i]
        predicted_clusters = calc_predicted_clusters(all_coref_logits[i].cpu().detach().unsqueeze(0), 
                                                        [gold_mentions], num_queries)
