    ...
    for step, batch in enumerate(epoch_iterator):
        ...
        if args.amp:
            with torch.cuda.amp.autocast():
                outputs = model(True, input_ids, sum_text_len, input_mask, gold_mentions, num_mentions, speaker_ids, genre)
            ...
            outputs = model(True, input_ids, sum_text_len, input_mask, gold_mentions, num_mentions, speaker_ids, genre, gold_matrix)
